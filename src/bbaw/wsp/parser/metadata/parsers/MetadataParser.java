...
import bbaw.wsp.parser.metadata.MetadataParserHelper;
...
public abstract class MetadataParser {
   ...
   *             file.
   */
  public MetadataParser(final String uri, final HashMap<String, String> namespaces) throws ApplicationException {
